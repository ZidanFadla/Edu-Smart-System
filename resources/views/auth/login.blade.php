    ...
    <div class="grid w-full max-w-5xl overflow-hidden rounded-2xl bg-white shadow-xl shadow-slate-200/60 md:grid-cols-[1fr_0.9fr]">
        ...
        <div class="hidden bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 p-10 text-white md:flex md:flex-col md:justify-between">
            <div>
                ...
                <h1 class="max-w-sm text-4xl font-bold leading-tight tracking-tight">Smart Edu System</h1>
                <p class="mt-4 max-w-md text-lg leading-relaxed text-indigo-100">aplikasi pengolahan nilai siswa yang membantu proses input, perhitungan, dan pelaporan nilai secara lebih cepat, akurat, dan terstruktur..</p>
            </div>
        ...
        <div class="p-7 sm:p-10">
            ...
            <div class="mb-5 flex items-center gap-2.5 rounded-xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-700">
                <svg class="size-4 shrink-0 text-rose-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
