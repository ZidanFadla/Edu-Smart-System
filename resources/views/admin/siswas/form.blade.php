        ...
        <div class="rounded-xl border border-indigo-100 bg-indigo-50/50 p-4">
            ...
            <div class="grid gap-4">
                <div>
                    ...
                    <input name="account_email" type="email" value="{{ old('account_email', $siswa->user?->email) }}" placeholder="contoh: nama.siswa@example.com" class="soft-input w-full px-3.5 py-2.5 text-sm" required>
                </div>
                <div>
