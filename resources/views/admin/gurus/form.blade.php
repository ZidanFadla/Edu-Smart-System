<form method="POST" action="{{ $action }}" class="panel max-w-2xl overflow-hidden">
    ...
    <div class="grid gap-5 p-6">
        <div>
            <label class="mb-2 block text-sm font-semibold text-slate-600">Akun Guru</label>
        ...
        <div class="rounded-xl border border-indigo-100 bg-indigo-50/50 p-4">
            ...
            <div class="grid gap-4">
                <div>
                    ...
                    <input name="account_email" type="email" value="{{ old('account_email', $guru->user?->email) }}" placeholder="contoh: nama.guru@example.com" class="soft-input w-full px-3.5 py-2.5 text-sm">
                </div>
                <div>
